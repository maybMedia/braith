...
export default function AboutPage() {
  return (
    <main className="page-enter bg-white dark:bg-slate-950">
      <section className="container-custom py-20 md:py-24">
        <div className="relative overflow-hidden rounded-4xl border border-slate-200 bg-linear-to-br from-white via-slate-50 to-cyan-50 px-6 py-12 shadow-sm md:px-10 dark:border-slate-800 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
          ...
          <div className="relative grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            ...
            <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-white p-8 shadow-sm scroll-reveal dark:border-slate-800 dark:bg-slate-900">
              <div className="motion-glow pointer-events-none absolute right-0 top-0 hidden h-28 w-28 rounded-full bg-blue-100/70 blur-3xl dark:bg-blue-500/10 md:block" />
      ...
      <section className="pb-20 md:pb-24">
        <div className="container-custom">
          <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-linear-to-br from-white via-slate-50 to-cyan-50 px-6 py-12 scroll-reveal md:px-12 dark:border-slate-800 dark:from-slate-900 dark:via-slate-950 dark:to-slate-900">
            <div className="motion-glow pointer-events-none absolute left-1/2 top-0 hidden h-32 w-32 -translate-x-1/2 rounded-full bg-cyan-200/40 blur-3xl dark:bg-cyan-400/10 md:block" />
