  ...
  return (
    <section className="bg-white dark:bg-slate-950">
      <div className="container-custom py-24">
        <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-linear-to-br from-slate-50 via-white to-blue-50 px-6 py-14 shadow-xl scroll-reveal md:px-12 md:py-16 dark:border-white/10 dark:from-slate-900 dark:via-slate-950 dark:to-blue-950 dark:shadow-2xl">
          <div className="motion-glow pointer-events-none absolute -left-10 top-0 hidden h-40 w-40 rounded-full bg-blue-500/10 blur-3xl dark:bg-blue-500/20 md:block" />
          <div className="motion-glow pointer-events-none absolute -right-10 bottom-0 hidden h-40 w-40 rounded-full bg-cyan-400/10 blur-3xl md:block" />

          <div className="relative z-10 mx-auto max-w-3xl text-center load-stagger">
